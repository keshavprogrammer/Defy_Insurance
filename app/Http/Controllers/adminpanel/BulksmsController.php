...
class BulksmsController extends Controller
{
    ...
    public function manage() {
        ...
        return view('adminpanel.bulksms', compact('data'));
    }
    public function multiplesms(Request $request) 
    {
        ...
        */
        ...
        if ($sms_data->id > 0) 
        {
            return redirect()->route('adminpanel.bulksms.manage')->with('success', 'SMS sent successfully.');
        }
        else{
            return redirect()->route('adminpanel.bulksms.manage')->withErrors(['SMS is not sent']);
        }
    }
}
