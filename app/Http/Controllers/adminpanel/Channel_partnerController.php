...
class Channel_partnerController extends Controller
{
    ...
    public function manage() {
        $data = Channel_partner::query()->paginate($this->pagination);
        return view('adminpanel.managechannel_partner', compact('data'));
    }
    ...
    public function add() {
        ...
        return view('adminpanel.addchannel_partner', compact('data'));
    }
    ...
    public function save(Request $request) {
        ...
        if($agency->id>0) {
            return redirect()->route('adminpanel.channel_partner.manage')->with('success', 'Created successfully.');
        } else {
            return redirect()->route('adminpanel.channel_partner.add')->withErrors(['Error creating record. Please try again.']);
        }
    }
    ...
    public function update(Request $request) {
        ...
        return redirect()->route('adminpanel.channel_partner.manage')->with('success', 'Updated successfully.');
	...
	public function delete($id) {
        ...
        return redirect()->route('adminpanel.channel_partner.manage')->with('success', 'Deleted successfully.');
    }

    public function channelpartnersinglesms(Request $request) {
        $input = $request->all();
        $channelPartnerId = $input['receiverid'];
        $message = $input['msg'];
        ...
        $channelPartnerData = Channel_partner::query()->where('id', '=', $channelPartnerId)->get();
        $phone_number = $channelPartnerData[0]->phone;
        ...
        if($sentResponse->sid != ''){
            ...
            return redirect()->route('adminpanel.channel_partner.manage')->with('success', 'SMS sent successfully.');
        }
        else{
            return redirect()->route('adminpanel.channel_partner.manage')->withErrors(['SMS is not sent']);
        }
    }    
