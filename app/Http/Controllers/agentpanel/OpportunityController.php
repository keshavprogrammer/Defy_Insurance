...
class OpportunityController extends Controller
{
    ...
    public function manage() {
    	$data = Lead::where("agent_id", "=", Auth::id())->where("mark_opportunity", "=", "1")->where("mark_client", "=", "0")->paginate($this->pagination);
        return view('agentpanel.manageopportunity', compact('data'));
    }
    ...
    public function edit($id) {
	    ...
	    return view('agentpanel.addopportunity', compact('data'));
	}
    ...
    public function update(Request $request) {
        ...
        return redirect()->route('agentpanel.opportunity.manage')->with('success', 'Updated successfully.');
	...
	public function delete($id) {
        ...
        return redirect()->route('agentpanel.opportunity.manage')->with('success', 'Deleted successfully.');
    }
