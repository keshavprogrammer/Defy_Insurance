...
class BulksmsController extends Controller
{
    ...
    public function manage() {
        ...
        return view('agentpanel.bulksms', compact('data'));
    }
    public function multiplesms(Request $request) 
    {
        ...
        */
        ...
        if($sentResponse->sid != '')
        {
            return redirect()->route('agentpanel.bulksms.manage')->with('success', 'SMS sent successfully.');
        }
        else{
            return redirect()->route('agentpanel.bulksms.manage')->withErrors(['SMS is not sent']);
        }
    }
}
