...
class SettingController extends Controller
{
     public function getsetting() {     	
    	$pagedata = Agent::where("id", "=", Auth::id())->get();
	    $data = array('type'=>'edit', 'pagedata'=>$pagedata);
	    return view('agentpanel.setting', compact('data'));
    }
    ...
    public function updatesetting(Request $request) {
        ...
        $agency = Agent::where('id', '=', $id)->update($update);
        return redirect('/agentpanel/setting/')->with('success', 'Updated Successfully');
