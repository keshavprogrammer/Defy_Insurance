...
class BulksmsController extends Controller
{
    ...
    public function manage() {
        ...
        return view('partnerpanel.bulksms', compact('data'));
    }
    public function multiplesms(Request $request) 
    {
        ...
        */
        ...
        if($sentResponse->sid != '')
        {
            return redirect()->route('partnerpanel.bulksms.manage')->with('success', 'SMS sent successfully.');
        }
        else{
            return redirect()->route('partnerpanel.bulksms.manage')->withErrors(['SMS is not sent']);
        }
    }
}
