...
class LeadController extends Controller
{
    ...
    public function manage() {
    	$data = Lead::where("channel_partner_id", "=", Auth::id())->where("mark_opportunity", "=", "0")->paginate($this->pagination);
        return view('partnerpanel.managelead', compact('data'));
    }
    ...
    public function add() {
        ...
        $data = array('type'=>'add', 'agenc_id'=>$agenc_id, 'channel_partner_id'=>Auth::id(), 'policyplan'=>$policyplan);        
        return view('partnerpanel.addlead', compact('data'));
    }
    ...
    public function save(Request $request) {
        ...
        if ($validator->fails()) {
        	...
        	$policyplan = Policyplan::where("status", "=", "1")->where("agenc_id", "=", $agenc_id)->pluck('title', 'id'); 
            $data = array('type'=>'add', 'input'=>$input, 'agenc_id'=>$agenc_id, 'channel_partner_id'=>Auth::id(), 'policyplan'=>$policyplan, 'error'=>$validator->messages());
            return view('partnerpanel.addlead', compact('data'));
            exit();            
        }
        ...
        if($agency->id>0) {
            return redirect()->route('partnerpanel.lead.manage')->with('success', 'Created successfully.');
        } else {
            return redirect()->route('partnerpanel.lead.add')->withErrors(['Error creating record. Please try again.']);
        }
    }
    ...
    public function edit($id) {
        ...
        $policyplan = Policyplan::where("status", "=", "1")->where("agenc_id", "=", $agenc_id)->pluck('title', 'id');
        $data = array('type'=>'edit', 'input'=>$input, 'agenc_id'=>$agenc_id, 'channel_partner_id'=>Auth::id(),'policyplan'=>$policyplan);
	    return view('partnerpanel.addlead', compact('data'));
	}
    ...
    public function update(Request $request) {
        ...
        if ($validator->fails()) { 
            ...
            $policyplan = Policyplan::where("status", "=", "1")->where("agenc_id", "=", $agenc_id)->pluck('title', 'id');
            $data = array('type'=>'Edit', 'input'=>$input,'policyplan'=>$policyplan, 'agenc_id'=>$agenc_id, 'channel_partner_id'=>Auth::id(), 'error'=>$validator->messages());
            return view('partnerpanel.addlead', compact('data'));
            exit();            
        }
        ...
        print_r($lead);
        return redirect()->route('partnerpanel.lead.manage')->with('success', 'Updated successfully.');
	...
	public function delete($id) {
        ...
        return redirect()->route('partnerpanel.lead.manage')->with('success', 'Deleted successfully.');
    }
