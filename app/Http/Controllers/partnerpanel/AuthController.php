...
class AuthController extends Controller
{
    public function login()
    {
        ...
        return view('partnerpanel.login');
    }
    ...
    public function submitlogin(Request $request) 
    {
    	...
    	try {
	            ...
	            if (Auth::guard('channel_partner')->attempt(['email' => $request->username, 'password' => $request->password], $request->get('remember'))) 
	            {
	          
	                return redirect()->route('partnerpanel.dashboard');
	            }
    ...
    public function logout() {
    	Auth::logout();
    	return redirect()->route('partnerpanel.login');
    }
