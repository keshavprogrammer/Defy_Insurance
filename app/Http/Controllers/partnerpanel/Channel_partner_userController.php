...
class Channel_partner_userController extends Controller
{
    ...
    public function manage() {
    	...
    	$data = Channel_partner_user::where("channel_partner_id", "=", Auth::id())->paginate($this->pagination);
        return view('partnerpanel.managechannel_partner_user', compact('data'));
    }
     public function channelusersinglesms(Request $request) {
        ...
        if($sentResponse->sid != ''){
            ...
            return redirect()->route('partnerpanel.channel_partner_user.manage')->with('success', 'SMS sent successfully.');
        }
        else{
            return redirect()->route('partnerpanel.channel_partner_user.manage')->withErrors(['SMS is not sent']);
        }
    }
    ...
    public function add() {
        ...
        $data = array('type'=>'add','agenc_id'=>$agenc_id, 'channel_partner_id'=>Auth::id());        
        return view('partnerpanel.addchannel_partner_user', compact('data'));
    }
    ...
    public function save(Request $request) {
        ...
        if ($validator->fails()) { 
            ...
            $data = array('type'=>'add', 'input'=>$input, 'agenc_id'=>$agenc_id, 'channel_partner_id'=>Auth::id(), 'error'=>$validator->messages());
            return view('partnerpanel.addchannel_partner_user', compact('data'));
            exit();            
        }
        ...
        if($agency->id>0) {
            return redirect()->route('partnerpanel.channel_partner_user.manage')->with('success', 'Created successfully.');
        } else {
            return redirect()->route('partnerpanel.channel_partner_user.add')->withErrors(['Error creating record. Please try again.']);
        }
    }
    ...
    public function edit($id) {
        ...
        $data = array('type'=>'edit', 'input'=>$input, 'agenc_id'=>$agenc_id, 'channel_partner_id'=>Auth::id());
	    return view('partnerpanel.addchannel_partner_user', compact('data'));
	}
	...
	public function update(Request $request) {
        ...
        if ($validator->fails()) { 
            ...
            $data = array('type'=>'Edit', 'input'=>$input, 'agenc_id'=>$agenc_id, 'channel_partner_id'=>Auth::id(), 'error'=>$validator->messages());
            return view('partnerpanel.addchannel_partner_user', compact('data'));
            exit();            
        }
        $update = array();
        ...
        return redirect()->route('partnerpanel.channel_partner_user.manage')->with('success', 'Updated successfully.');
	...
	public function delete($id) {
        ...
        return redirect()->route('partnerpanel.channel_partner_user.manage')->with('success', 'Deleted successfully.');
    }
