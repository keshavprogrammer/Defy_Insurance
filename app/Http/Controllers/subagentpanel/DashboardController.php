...
class DashboardController extends Controller
{
    ...
    public function index() {
    	...
    	$data = array(    		
    		'Leads' => Lead::where("subagent_id", "=", Auth::id())->where("mark_opportunity", "=", "0")->count(),
    		'Opportunity' => Lead::where("subagent_id", "=", Auth::id())->where("mark_opportunity", "=", "1")->where("mark_client", "=", "0")->count(),
    		'Client' => Client::where("subagent_id", "=", Auth::id())->count(),
    	);
    	return view('subagentpanel.dashboard', compact('data'));
    }
}
