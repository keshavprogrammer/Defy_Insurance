...
@section('title', 'Add/Edit Sub Agent')
...
<style>
    .file-upload-button
    {
        width: 120px
                ...
                $id = "";
                $isError = false;
                $formRoute = 'agentpanel.subagent.save';
                $photo = asset('adminpanel/images/default-user.jpg');
                if(isset($data['error'])) {
                    $isError = true;
                    if($data['type']=="Edit") {
                        $label = "Edit";
                        $formRoute = 'agentpanel.subagent.update';
                    }
                    ...
                    if($data['type'] == "edit") {
                        ...
                        $eno_file = $data['input'][0]->eno_file_path;
                ...
                <div class="top-dashboard-title">
                    <div class="d-code-main">
                        <div class="d-title">
                            <h4><strong>{{ $label }} Sub Agent</strong><span>|</span>Enter Sub Agent details and submit </h4>
                        </div>
                    </div>
                                    ...
                                    <div class="user-pro-detail-content">
                                        ...
                                        <div class="user-pro-detail-content-dt-one">
                                            ...
                                            <div class="user-pro-detail-content-right">
                                                ...
                                                @if ($eno_file)
                                                    <a href="{{ $eno_file }}" type="button" class="btn btn-default btn-lg">
                                                        <i class="fas fa-eye"></i>download
                                                    </a>
                                                    <button type="button" class="ml-2 close text-danger" aria-label="Close">
