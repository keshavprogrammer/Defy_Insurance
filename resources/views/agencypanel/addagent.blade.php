...
@section('content')
            ...
            <?php
                ...
                $id = "";
                $isError = false;
                $formRoute = 'agencypanel.agent.save';
                $photo = asset('adminpanel/images/default-user.jpg');
                if(isset($data['error'])) {
                    $isError = true;
                    if($data['type']=="Edit") {
                        $label = "Edit";
                        $formRoute = 'agencypanel.agent.update';
                    }
                ...
                <div class="top-dashboard-title">
                    <div class="d-code-main">
                        <div class="d-title">
                            <h4><strong>{{ $label }} Agent</strong><span>|</span>Enter Agent details and submit </h4>
                        </div>
                    </div>                  
                </div>
