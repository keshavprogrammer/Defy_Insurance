...
<head>
    ...
    @if( Session::get('agenc_theme_id') == '1')         
      	<link href="{{ asset('adminpanel/css/style.css') }}" rel="stylesheet">      	
	@elseif( Session::get('agenc_theme_id') == '2')
		<link href="{{ asset('adminpanel/css/style_green.css') }}" rel="stylesheet">      	
	@elseif( Session::get('agenc_theme_id') == '3')
		<link href="{{ asset('adminpanel/css/style_purple.css') }}" rel="stylesheet">      	
	@else
      	<link href="{{ asset('adminpanel/css/style.css') }}" rel="stylesheet">      	
	@endif
...
<div id="sitemain">
    ...
    <div class="dashboard-main" id="dashboard">
    	...
    	@include('partneruserpanel.include.sidebar')

        <div class="dashboard-right-side-main">

            @include('partneruserpanel.include.header')

            @yield('content')
            
            @include('partneruserpanel.include.footer')
