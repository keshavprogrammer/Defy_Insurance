...
Route::group(['middleware' => 'auth:agency'], function(){
	...
	Route::get('/ajaxSubAgentLoader', 'LeadController@ajaxSubAgentLoader')->name('lead.ajaxSubAgentLoader');
	...
	Route::post('/channelsinglesms', 'Channel_partnerController@channelsinglesms')->name('channel_partner.channelsinglesms');
